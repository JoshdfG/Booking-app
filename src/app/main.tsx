        ...
        <div className=" mx-auto w-[80%] md:w-[75%]  text-white  md:items-center md:justify-center   md:flex md:flex-row-reverse mt-12">
          ...
          >
            ...
            <p className="tracking-wider text-area ">
              ...
              quisquam explicabo eos ratione dolore ab animi molestias suscipit,
              natus optio sequi id? Id, modi dolorem. Ratione veniam laboriosam
              blanditiis maiores. Repellat amet eius itaque corrupti at
              excepturi facilis deleniti delectus quia!
            </p>
